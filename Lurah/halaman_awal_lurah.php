<!-- Container Fluid-->
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h2 class="h4 mb-0 text-gray-800">Dashboard Lurah</h2>
            <ol class="breadcrumb">
              ...
              if(isset($_GET['notif'])){
                if($_GET['notif']=="login-sukses"){
                  echo "<div class='alert alert-success alert-dismissible'>
                        <a style='text-decoration:none;' href='dashboard_lurah.php?p=halaman_awal_lurah' type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</a>
            ...
            <div class="col-xl-12 col-md-6 mb-4">
              <div class="card mb-12">
                <div class="card-body" style="text-align: center;">
                  <h4>Selamat Datang Di Sistem Pendukung Keputusan Klasifikasi Masyarakat Miskin Pada Kelurahan Panjer</h4>  
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Data Klasifikasi</div>
                      <?php 
                         include"koneksi.php";
                         $order="SELECT * FROM tbl_klasifikasi";
                         ...
                         ?>
                      <div class="h6 mb-0 mr-3 font-weight-bold text-gray-800"><font size="2"><?php echo $count;  ?> Data Klasifikasi</font></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Masyarakat Miskin</div>
                      <?php 
                         include"koneksi.php";
                         $order_a="SELECT * FROM tbl_score_akhir WHERE status='Miskin'";
                         ...
                         ?>
                      <div class=" mb-0 mr-3 font-weight-bold text-gray-800" ><font size="2"><?php echo $count_a;  ?> Data Miskin</font></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      ...
                      <?php 
                         include"koneksi.php";
                         $order_b="SELECT * FROM tbl_score_akhir";
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-0">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Masyarakat Tidak Miskin</div>
                      <?php 
                         include"koneksi.php";
                         $order_d="SELECT * FROM tbl_score_akhir WHERE status='Tidak Miskin'";
                      ...
                      <div class="h6 mb-0 mr-3 font-weight-bold text-gray-800"><font size="2"><?php echo $count_d;  ?> Data Tidak Miskin</font></div>
                    </div>
                    <div class="col-auto">
