...
<head>
  ...
  <title>Kantor Kelurahan Panjer - Login</title>
              ...
              <div class="col-lg-12">
                <div class="login-form">
                  <div class="text-center">
                    <img src="img/logon.png" style="width:230px; height: 200px;">
                    <h2 class="h4 text-gray-900 mb-4" style="margin-top: 20px;">KANTOR KELURAHAN PANJER</h2>
                    <h6 class="h6 text-gray-900 mb-4" style="margin-top: 20px;">Jl. Tukad Pakerisan NO. 65, Denpasar-Bali</h6>
                  </div>
                  <?php
                    if(isset($_GET['notif'])){
