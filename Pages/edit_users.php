                ...
                <div class="card-body">
                  ...
                  <form method="post" action="proses_edit_user.php?id=<?php echo $id;?>">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" value="<?php echo $data['username'];?>" name="username" required="required">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      <div class="col-sm-10">
                        ...
                        <a href="dashboard.php?p=data_users" class="btn btn-danger"><i class="fa fa-close"></i>Batal</a>
                      </div>
                    </div>
                  </form>
                </div>
