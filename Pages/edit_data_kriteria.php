                  ...
                  $data_a=mysqli_fetch_array($sql_a);?>
                   <form method="post" action="proses_edit_data_kriteria.php?id=<?php echo $id;?>" enctype="multipart/form-data">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" value="<?php echo $data_a['bobot'];?>" name="bobot" required="required">
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-sm-10">
                        <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Simpan Perubahan</button>
                        <a href="dashboard.php?p=data_kriteria" class="btn btn-danger"><i class="fa fa-spinner"></i> Batal</a>
                      </div>
                    </div>
                  </form>
                </div>
