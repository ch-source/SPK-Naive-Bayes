                  ...
                  <table class="table align-items-center table-hover table-bordered" id="dataTableHover">
                    ...
                    <tbody>
                      ...
                      <tr>
                         ...
                         <td><?php echo $data_user['bobot'];?></td>
                         <td><a href="dashboard.php?p=edit_data_kriteria&id=<?php echo $data_user['id_kriteria'];?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
